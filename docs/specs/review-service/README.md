...
GitCode adapter、Repository Knowledge implementation、Review Engine implementation、durable store/dedup、MCP 和 Scheduler 将在对应 milestone 实现后再增加规范，不从 architecture 提前声明为现有能力。
